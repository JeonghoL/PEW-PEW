...
const char* charactervs = "charactervs.glsl";
const char* characterfs = "characterfs.glsl";
...
MainCharacter::MainCharacter()
{
    ...
    Texture = textureLoader.loadTexture("texture/cattexture.png");
    setupShader(charactervs, characterfs, shaderprogram);
}


void MainCharacter::draw(float deltaTime, MainCharacter* mainCat, float angle, glm::mat4 view, glm::mat4 projection, glm::vec3 viewPos, glm::mat4 lightSpaceMatrix, GLuint depthMap)
{
    if (!dead)
    {
