...
public:
	...
	void draw(float deltaTime, MainCharacter* mainCat, float angle, glm::mat4 view, glm::mat4 projection, glm::vec3 viewPos, glm::mat4 lightSpaceMatrix, GLuint depthMap);
