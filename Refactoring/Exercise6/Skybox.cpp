...
Skybox::Skybox()
{
    ...
    setskyboxupShader("SkyboxVert.glsl", "SkyboxFrag.glsl", shaderprogram);
    setskyboxVertices();
...
void Skybox::setskyboxupShader(const char* vertexName, const char* fragmentName, GLuint& shaderName)
{
